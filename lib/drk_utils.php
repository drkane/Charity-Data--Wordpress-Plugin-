...
/**
 * Safe number formatting - if a string is given the return it, rather than throwing an error
 */	
if ( ! function_exists ( 'drk_number_format' ) ) {
function drk_number_format ( $number , $decimals = 0 , $dec_point = '.' , $thousands_sep = ',' ) {
